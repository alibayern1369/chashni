  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl gap-2 px-4 py-3">
        <button
          type="button"
          onClick={() => router.push(pathForLocale("/build-burger", locale, slug))}
          className="relative flex shrink-0 items-center gap-1.5 rounded-full bg-gradient-to-r from-[var(--pastel-mint)] to-[var(--pastel-peach)] px-4 py-2 text-sm font-bold whitespace-nowrap text-[#0b0d10] shadow-[0_8px_24px_rgba(168,230,207,0.25)]"
        >
          <span>🍔</span>
          <span>{locale === "fa" ? "برگر بساز" : "Build Burger"}</span>
        </button>
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-full bg-gradient-to-r from-[var(--pastel-mint)]/85 to-[var(--pastel-peach)]/85"
